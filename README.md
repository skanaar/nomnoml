...
The [nomnoml](http://www.nomnoml.com) standalone javascript library can be used to render diagrams on your own web page. Install it using either *npm* or good old script inclusion.
